...
(1, 'agent', 'b33aed8f3134996703dc39f9a7c95783', '線上客服', '2020-06-27 19:32:41', '2020-07-04 09:32:20', NULL, '/static/images/kf.png');
...
(NULL, '公告', 'AllNotice', '歡迎使用線上客服。','agent');
INSERT INTO `config` (`id`, `conf_name`, `conf_key`, `conf_value`, `user_id`) VALUES
(NULL, '離線訊息', 'OfflineMessage', '目前客服暫時離線，請留下訊息，我們會盡快回覆您。','agent');
INSERT INTO `config` (`id`, `conf_name`, `conf_key`, `conf_value`, `user_id`) VALUES
(NULL, '歡迎訊息', 'WelcomeMessage', '您好，這裡是線上客服，請問有什麼可以幫您？','agent');
INSERT INTO `config` (`id`, `conf_name`, `conf_key`, `conf_value`, `user_id`) VALUES
